...
enum AIType { GUARD, JUMPER, WALKER };
...
public:
    ...
    int       const get_numLives()        const { return numLives; }
    bool      const get_activity_status() const { return m_is_active; }
    ...
    void const set_numLives(float new_life) {numLives = new_life; }
