...
int player_walking_animationM[4][4] =
{
...
void Menu::Initialize(int numLives) {
    ...
    m_game_state.player = new Entity(
                                     ...
                                     7.0f,                      // jumping power
                                     player_walking_animationM,  // animation index sets
                                     0.0f,                      // animation time
...
void Menu::render(ShaderProgram *program) {
    Utility::draw_text(program, Utility::load_texture("font1.png"), "Press Enter", 1, -0.5, glm::vec3(2.25f, -3.0f, 0));
    Utility::draw_text(program, Utility::load_texture("font1.png"), "to Start", 1, -0.5, glm::vec3(3.25f, -4.0f, 0));
